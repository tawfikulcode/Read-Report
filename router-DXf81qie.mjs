...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DXf81qie.js
var router_DXf81qie_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-DWmS2jVo.css";
var APP_NAME = "StudyReport AI";
var THEME_BOOT = `(function(){try{var r=localStorage.getItem("studyreport:settings");if(!r)return;var t=JSON.parse(r).theme;if(t==="light"||t==="dark")document.documentElement.setAttribute("data-theme",t);}catch(e){}})();`;
...
var $$splitComponentImporter = () => import("./routes-DMIP66HF.mjs");
...
//#endregion
export { getRouter, router_DXf81qie_exports as t };
